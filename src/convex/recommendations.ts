...
export const generateForProject = mutation({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      console.error("recommendations.generateForProject error", { args, err });
...
export const listByProject = query({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      console.error("recommendations.listByProject error", { args, err });
      return [];
    }
  },
});
...
export const toggleComplete = mutation({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      console.error("recommendations.toggleComplete error", { args, err });
