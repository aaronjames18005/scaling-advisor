                    ...
                    return (
                      <g key={edge.id} className="pointer-events-none">
                        ...
                        <path
                          d={path}
                          stroke="black"
                          strokeWidth={isActive ? 4.2 : 3.8} // increased for better contrast
                          strokeLinecap="round"
                        ...
                        <path
                          d={path}
                          stroke="#ffffff"
                          strokeWidth={isActive ? 3.9 : 3.5} // increased sheath
                          strokeLinecap="round"
                          strokeLinejoin="round"
                    ...
                    return (
                      <g className="pointer-events-none">
                        ...
                        <path
                          d={path}
                          stroke="black"
                          strokeWidth={3.8} // increased preview shadow
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="opacity-40"
                          fill="none"
                        ...
                        <path
                          d={path}
                          stroke="#ffffff"
                          strokeWidth={3.5} // increased preview sheath
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="opacity-100"
                          fill="none"
